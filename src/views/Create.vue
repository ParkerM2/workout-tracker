  ...
  setup() {
    ...
    // Add exercise
      const addExercise = () => {
        ...
        // need an else if statement if more exercise types or API for exercises is integrated
        exercises.value.push({
          id: uid(),
          cardioType:"",
          distance: "",
    ...
    // Delete exercise
      const deleteExercise = (id) => {
        // creates new exercises array that doesn't contain the exercise with the uid of the one passed into the function
